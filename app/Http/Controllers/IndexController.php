...
class IndexController extends Controller
{
    public function index(){
		...
		$topten = OrdersProduct::select(DB::raw('products.*, SUM(orders_products.product_qty) AS jumlah'))
    	...
    	return view('index')->with(compact('productsAll','categories_menu','categories','banners','meta_title','meta_description','meta_keywords','topten'));
    }
}
