	...
	<table width='700px'>
		...
		<tr><td>
			<table width='95%' cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
				...
				@endforeach
				<tr>
					<td colspan="5" align="right">Shipping Charges</td><td>IDR {{ number_format($productDetails['shipping_charges'],0,',','.') }}</td>
				</tr>
				<tr>
					<td colspan="5" align="right">Coupon Discount</td><td>IDR {{ number_format($productDetails['coupon_amount'],0,',','.') }}</td>
				</tr>
				<tr>
					<td colspan="5" align="right">Grand Total</td><td>IDR {{ number_format($productDetails['grand_total'],0,',','.') }}</td>
				</tr>
			</table>
		</td></tr>
		<tr><td>
