...
<section id="do_action">
	<div class="container">
		<div class="heading" align="center">
			...
			<p>Your order number is {{ Session::get('order_id') }} and total payable about is IDR {{ number_format(Session::get('grand_total'),0,',','.') }}</p>
	...
	number_format(			<input type="hidden" ,0,',','.')name="amount" value="{{ Session::get('grand_total') }}">
