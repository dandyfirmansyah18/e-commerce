    					...
    					<table class="table table-condensed">
    						...
    						<tbody>
    							...
    							<tr>
    								...
    								<td class="text-center">IDR {{ number_format($pro->product_price,0,',','.') }}</td>
    								<td class="text-center">{{ $pro->product_qty }}</td>
    								<td class="text-right">IDR {{ number_format($pro->product_price * $pro->product_qty,0,',','.') }}</td>
    							</tr>
    							...
    							<tr>
    								...
    								<td class="thick-line text-right">IDR {{ number_format($Subtotal,0,',','.') }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    							...
    							<tr>
    								...
    								<td class="no-line text-right">IDR {{ number_format($orderDetails->coupon_amount,0,',','.') }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">IDR {{ number_format($orderDetails->grand_total,0,',','.') }}</td>
    							</tr>
    						</tbody>
    					</table>
    				</div>
