					...
					<tbody>
						...
						@foreach($userCart as $cart)
							<tr>
								...
								<td class="cart_price">
									<p>IDR {{ number_format($cart->price,0,',','.') }}</p>
								</td>
								...
								<td class="cart_total">
									<p class="cart_total_price">IDR {{ number_format($cart->price*$cart->quantity,0,',','.') }}</p>
								</td>
				...
				<div class="total_area">
					<ul>
						@if(!empty(Session::get('CouponAmount')))
							<li>Sub Total <span>IDR <?php echo number_format($total_amount,0,',','.'); ?></span></li>
							<li>Coupon Discount <span>IDR <?php echo number_format(Session::get('CouponAmount'),0,',','.'); ?></span></li>
							<?php 
							...
							<li>Grand Total <span class="btn-secondary" data-toggle="tooltip" data-html="true" title="">
								IDR <?php echo number_format($total_amount,0,',','.'); ?></span></li>
						@else
